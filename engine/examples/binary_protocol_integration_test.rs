...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("📊 Insert throughput: {:.2} ops/sec", 
    ...
    for &batch_size in &batch_sizes {
        ...
        println!("📊 Batch size {}: {:?} avg latency, {:.2} ops/sec, {:.1}% hit rate",
    ...
    println!("📊 Single lookup: {:?} avg latency, {:.2} ops/sec, {:.1}% hit rate",
    ...
    println!("📊 Mixed workload: {:.2} ops/sec total throughput", mixed_throughput);
    ...
    #[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
    {
        ...
        println!("📊 AVX2 16-key vectorization: {:.2} ops/sec", avx2_throughput);
    }
    ...
    #[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
    {
        ...
        println!("📊 NEON 4-key vectorization: {:.2} ops/sec", neon_throughput);
    }
    ...
    )))]
    {
        ...
        println!("📊 Scalar batch processing: {:.2} ops/sec", scalar_throughput);
    }
    ...
    println!("📊 Stress test: {:.2} ops/sec, {:.2}% stability", 
