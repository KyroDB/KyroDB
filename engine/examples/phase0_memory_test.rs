...
fn main() {
    ...
    println!("   Initial state: {} bytes allocated", initial_stats.total_allocated);
    ...
    println!("   Total operations: {} allocs, {} deallocs", 
    ...
    println!("  🔻 Deallocation count: {}", final_stats.deallocation_count);
